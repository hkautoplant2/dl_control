...
ssh autoplant2@192.168.1.102 'docker cp inference/run_inf_host/. 7efb4eb06822:/workspace/run_inf_cont'

#Execute inference on the image
ssh autoplant2@192.168.1.102 'docker exec -i 7efb4eb06822 tlt-infer faster_rcnn -e /workspace/examples/faster_rcnn/specs/fastrcnn_retrain_pruned12.txt'

#Copy resulting labeled image and label file to local host map 
ssh autoplant2@192.168.1.102 'docker cp 7efb4eb06822:/workspace/res_inf_cont/. ~/inference/res_inf_host'
